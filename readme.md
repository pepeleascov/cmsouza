...
// https://cmsouzan20250-rest.vistahost.com.br/clientes/detalhes?key=ce32f219b5131de09ef055a8cca7835f
{
  "fields": {
    "Cliente": "101526",
    "Historico": {
      "Assunto": "Mensagem Chatbot",
      "Texto": "Novo teste de notificação"
    }
  }
}
...

{
  "fields": {
    ...
    "Historico": {
      "Assunto": "Mensagem Chatbot",
      "Texto": "Last Message do cliente"
    }
  }
}

https://cmsouza.com.br/lead/vars/delete

{
  "contact_id": "{{contact_id}}"
}

https://api.cmsouza.com.br/lead

{
  "flow_id": "6434871175e30ce86f0afe49",
    "contact_id": "{{contact_id}}",
      "departamento": "11",
        "nome": "{{full_name}}",
          "telefone": "{{phone}}",
...
"name": "Home",
  "id": "64348cbc0e903f1ef903bb3a"


"name": "Dupla Finalidade",
  "id": "6434871175e30ce86f0afe49"


"name": "Imovel OK",
  "id": "643486b46e3a989132097567"



{{$['FotoDestaque']}}

Abaixo estão algumas informações sobre o imóvel {{codigo}} que você solicitou:

{{$['Categoria']}}, {{$['Empreendimento']}}
Localização: {{$['BairroComercial']}}, {{$['Cidade']}}
Com {{$['Dormitorios']}} quartos e {{$['Banheiros']}} banheiros, e área total de {{$['AreaTotal']}}M²
Por R${{$['ValorLocacao'] | number_format(decimals="2", decimal_separator=",", thousands_separator=".") }} + condomínio
À venda por R${{$['ValorVenda'] | number_format(decimals="2", decimal_separator=",", thousands_separator=".") }}


incluir 'codigo' do response do vista ao enviar lead
-->
